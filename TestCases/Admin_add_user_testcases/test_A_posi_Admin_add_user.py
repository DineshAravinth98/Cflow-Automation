...
class Test_002_Admin_Add_User_positive_case:
    ...
    def test_add_user(self, login):
        ...
        admin.enter_employee_number("E01")
        page.wait_for_timeout(500)
        ...
        helper.verify_user_in_all_users(username)
        status = helper.verify_user_status_toggle(username)
